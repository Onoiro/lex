...
- **Время ответа:** В режиме повторения отслеживается время от показа слова до нажатия кнопки. Лучшее и среднее время отображаются над словом. Живой таймер останавливается при ответе. При новом рекорде таймер становится зелёным. В словаре отображаются best и avg время, а также интервал.
- **Тестирование:** 
