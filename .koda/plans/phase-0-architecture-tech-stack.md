...
3. [ ] **Define TypeScript types for the Word model**
...
4. [ ] **Set up project folder structure with placeholder modules**
...
5. [ ] **Set up linting and testing framework**
...
6. [ ] **Verify: build, lint, test all pass**
